...
package com.android.settings.powersaver;
...
public class PowerSaverSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mPowerSaverPref = (PowerSaverPreference) prefSet.findPreference(KEY_POWER_SAVER);
        mTogglesGPS.setChecked(Settings.System.getInt(resolver,
                Settings.System.KEY_POWER_SAVER, 0) != 0);
        setPrefsEnabledState(mPowerSaverPref);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mTogglesMobileData) {
            ...
            Settings.System.putInt(resolver, Settings.System.POWER_SAVER_GPS,
                    mTogglesMobileData.isChecked() ? 1 : 0);
        } else if (preference == mPowerSaverPref) {
